...
import TextContentRight4 from "./TextContentRight4";
function CardLeftContent3() {
            ...
            <div className="bg-background-100 bg1 dark:bg-background-70 h-screen mt-1  drop-shadow-md rounded-md relative border-[2px] border-border-100 ">
                ...
                <div className="float-left w-6/12">
                    <div className="grid h-56 place-content-center">
                        <h1 className="text-white font-bold text-5xl pt-52">SECURITY &</h1>
                        <h1 className="text-white font-bold text-yellow-500 text-5xl pt-3">COMPILANCE</h1>
                    </div>
                </div>
...
export default CardLeftContent3;